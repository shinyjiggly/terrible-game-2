...
module Atoa
  ...
  # of each character
  Custom_Stat_Position = [[313,180],[313, 258],[313,346],[427,145],[427,233],[427,315],[427,391],[535,180],[535,258],[535,346]]

  # Configuration of the Attributes Battle Window
  # Battle_Window = [Position X, Position Y, Width, Height, Opacity, Trasparent Edge]
  Battle_Window = [0 , 0, 640, 480, 0, true]
...
class Window_Base
  ...
  def draw_actor_hp(actor, x, y, width = 44) #edited
    if $game_temp.in_battle or Text_Format_in_Menu
      self.contents.font.color = system_color
  ...
  def set_default_font
    ...
    self.contents.font.size = 12 #Font.default_size
