...
module Atoa
  ...
  #    Equipment_Sprite['Weapon'][3] = ['_steelsword', true]
  #    Equipment_Sprite['Weapon'][4] = ['_mythrilsword', true]
  #    An Actor with battler graphic named '001-Fighter01', that uses two weapons
  ...
  #    '001-Fighter01_mythrilsword1'
  
  Equipment_Sprite['Weapon'][4] = ['_mythrilsword', true]
  Equipment_Sprite['Weapon'][45] = ['_goldsword', true]
  
  Equipment_Sprite['Armor'][16] = ['_mythrilarmor', true]
  Equipment_Sprite['Armor'][43] = ['_goldarmor', true]
