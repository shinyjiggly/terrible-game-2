...
module Atoa
  ...
  Enemy_Settings[1] = ["NOCOLLAPSE","TIMEBEFOREANIM/10"]
  Enemy_Settings[2] = ["NOCOLLAPSE"]
  ...
  Skill_Settings[1] = ["MOVETYPE/STEPFOWARD","TARGETSWITCH"]
  Skill_Settings[2] = ["MOVETYPE/STEPFOWARD","TARGETSWITCH"]
  ...
  Skill_Settings[57] = ["MOVEPOSITION/50,0,150,0,300","MIRAGEADVANCE/nil","MIRAGEACTION/nil"]
  ...
  Weapon_Settings[44] = ["STARTTHROWWEAPON/nil,10,126,126,126,126,200,0,-20,0,0",
                         "ENDTHROWWEAPON/nil,10,126,126,126,126,200,0,-20,0,0",
