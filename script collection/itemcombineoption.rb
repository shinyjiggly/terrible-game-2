...
#==============================================================================
  ...
  #          CODE       ITEMS 
  # ==============      ========
    COMBINE['I12']    = [ 1, 1 ]  # Takes two potions and makes 
    COMBINE['I7']     = [ 1, 2 ]  # Takes a potion and high potion to make 
    COMBINE['I8']     = [ 1, 3 ]
    COMBINE['I9']     = [ 1, 4 ]
    COMBINE['I10']    = [ 1, 5 ]
    COMBINE['I11']    = [ 1, 6 ]
  ...
  #
    NON_COMBINE       = true    # If you fail to combine items and make garbage
