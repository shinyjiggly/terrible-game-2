...
class Spriteset_Battle
  ...
  def initialize
    # Make viewports
    @viewport1 = Viewport.new(0, 0, 640, 480) #edited
    ...
    @actor_sprites.push(Sprite_Battler.new(@viewport2))
    @actor_sprites.push(Sprite_Battler.new(@viewport2))
    @actor_sprites.push(Sprite_Battler.new(@viewport2)) #edit beyond here
    @actor_sprites.push(Sprite_Battler.new(@viewport2))
    @actor_sprites.push(Sprite_Battler.new(@viewport2))
    @actor_sprites.push(Sprite_Battler.new(@viewport2))
    @actor_sprites.push(Sprite_Battler.new(@viewport2))
    @actor_sprites.push(Sprite_Battler.new(@viewport2))
    @actor_sprites.push(Sprite_Battler.new(@viewport2)) #10
    # Make weather
  ...
  def update
    ...
    @actor_sprites[3].battler = $game_party.actors[3] #edit beyond here
    ...
    if @battleback_name != $game_temp.battleback_name
      ...
      @battleback_sprite.src_rect.set(0, 0, 640, 480) #EDITED
    end
