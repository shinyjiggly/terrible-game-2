...
module Atoa
  ...
  Weapon_Custom_Formula[1] = "( {atk} / 8 + rand({atk}) ) * [(({str}+{atk})-({def})),1].max" #gunaxe
  Weapon_Custom_Formula[2] = "({atk} + rand({atk}) / 8) * [(({str}+{atk})-({def})),1].max" #sword
  ...
  Weapon_Custom_Formula[6] = "({atk} + rand({atk}) / 4) * ({str} + user.dex) / 2 - {def}" #knife
  ...
  Weapon_Custom_Formula[13] = "({atk} * 2 + rand({atk}) / 8) * [(({str}+{atk})-({def}*2)),1].max" #whip
  Weapon_Custom_Formula[14] = "({atk} * 2 + rand({atk}) / 8) * [(({str}+{atk})-({def}*2)),1].max" #claws
  ...
  Skill_Custom_Formula[3] = "rand(5) * ({atk} + rand({atk}))" #gun of five
